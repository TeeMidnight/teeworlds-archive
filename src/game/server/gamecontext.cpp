...
void CGameContext::OnUpdatePlayerServerInfo(CJsonStringWriter *pJsonWriter, int ClientID)
{
	...
	pJsonWriter->WriteIntValue(m_apPlayers[ClientID]->GetTeam() == TEAM_SPECTATORS ? -1 : 0);
}
